package com.osmeet.os.view.widget.behavior;
...
public class BottomBarBehavior extends CoordinatorLayout.Behavior<View> {
     ...
     * @param directTargetChild 我的理解是在CoordinateLayout下作为父View,而该View的子类是Tager的那个View,
     *                          也就是Target的父View),因为我测试用ViewPager包裹了RecycleView后
     *                          该参数返回Viewpager,如果没有包裹参数返回的是RecycleView
